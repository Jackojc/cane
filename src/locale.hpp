...
namespace cane {
	...
	constexpr View STR_PREFIX        = "expecting a sequence, identifier or prefix operator"_sv;
	constexpr View STR_INFIX         = "expecting an infix operator"_sv;
	constexpr View STR_INFIX_EXPR    = "expecting an infix operator"_sv;
	constexpr View STR_INFIX_LITERAL = "expecting an infix operator with literal argument"_sv;
