...
namespace cane {
	...
	constexpr View STR_NO_BPM       = "no global tempo specified"_sv;
	constexpr View STR_NO_NOTE      = "no global base note specified"_sv;
	...
	constexpr View STR_DEBUG = "`{}`(x{}), {} steps"_sv;
